...
variable "owner" {
  description = "Owner used for labeling"
  type        = string
}
variable "location" {
...
variable "sa_reader_email" {
  description = "The Reader SA used for testing secret role assignment"
  type        = string
  default     = ""
}
variable "sa_owner_email" {
  description = "The Owner SA used for testing secret role assignment"
  type        = string
  default     = ""
}
